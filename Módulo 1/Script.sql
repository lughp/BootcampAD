...
select e.pnome, d.nome_dependente, d.parentesco
from empregado e
...
select e.pnome, p.pjnome, t.horas
from empregado e
...
SELECT E.PNOME, D.DNOME, P.PJNOME, T.HORAS
FROM EMPREGADO E
INNER JOIN DEPARTAMENTO D
ON D.GERSSN = E.SSN
INNER JOIN PROJETO P
...
INNER JOIN TRABALHA_EM T
ON T.ESSN = E.SSN
WHERE D.DNUMERO = 5 AND P.PJNOME = 'ProductX';

SELECT E.PNOME AS FUNCIONARIO, S.PNOME AS SUPERVISOR
FROM EMPREGADO E
INNER JOIN EMPREGADO S
ON E.SUPERSSN = S.SSN;

SELECT E.PNOME AS FUNCIONARIO, P.PJNOME AS PROJETO, E.SALARIO AS SALARIO, D.DNOME AS DEPARTAMENTO, T.HORAS AS HORAS FROM EMPREGADO E
INNER JOIN DEPARTAMENTO D ON E.DNO = D.DNUMERO
INNER JOIN TRABALHA_EM T ON T.ESSN = E.SSN
INNER JOIN PROJETO P ON P.PNUMERO = T.PNO
WHERE P.PJNOME = 'ProductX' AND E.DNO = 5;

SELECT AVG(E.SALARIO) AS "Media Salarial", D.DNOME AS "Departamento"
FROM EMPREGADO E
INNER JOIN DEPARTAMENTO D
ON E.DNO = D.DNUMERO
GROUP BY D.DNOME;